...
export default {
  initialScreenUsers: (
    notIntroScreen: any,
    _: any,
    getState: () => {(): any; new (): any; users: any},
  ) => {
  ...
  listUsers: (
    res: any,
    _: any,
    getState: () => {(): any; new (): any; etablishment: any},
  ) => {
    if (res) {
      const etablishment =
  ...
  addAddress: (
    addressId: {hasOwnProperty: (arg0: string) => any},
    _data: any,
    getState: () => {(): any; new (): any; users: any},
  ) => {
  ...
  authAppleUsers: (
    res: {data: {token: any}; error: any; email: any},
    data: any,
    getState: () => {(): any; new (): any; users: any},
  ) => {
    if (res && res.data && !res.data.token) {
